...
Versionen 0.9.16–0.9.25 geführt haben. Keine Token-Werte — nur
...
## Aktuelle Login-Kette (0.9.25)

1. Eigenes Chromium-Fenster (privates Profil, DevTools-Port, Flatpak-fähig)
   öffnet den Web Reader.
2. Storage-Grab (localStorage + sessionStorage + IndexedDB) → frischester
   `typ: Refresh`-Kandidat.
